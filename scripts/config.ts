...
import { PNGCompressPlugin } from './PNGCompressPlugin';
        ...
        if (command == 'build') {
            ...
            return {
                ...
                commands: [
                    ...
                    new ResDepotPlugin(),
                    new PNGCompressPlugin([path.join(projectRoot, "resource", "assets"), path.join(projectRoot, "web")]),
                    ...
                    new DirCopyPlugin({from: path.join(projectRoot, 'web'), to: path.join(outputDir, 'web')}),
                    new DirCopyPlugin({
